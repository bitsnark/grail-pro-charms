...
export declare function injectSignaturesIntoSpell(context: IContext, spell: Spell, previousNftTxid: string, signatureRequest: SignatureRequest, fromCosigners: SignatureResponse[]): Promise<Spell>;
