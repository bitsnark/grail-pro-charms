...
async function main() {
    ...
    const signaturePackage = await (0, spell_operations_1.signSpell)(context, spell, previousNftTxid, {
        publicKeys: newPublicKeys,
        threshold: newThreshold,
    }, null, prepareKeypairs(privateKeys));
    const signedSpell = await (0, spell_operations_1.injectSignaturesIntoSpell)(context, spell, previousNftTxid, signaturePackage);
