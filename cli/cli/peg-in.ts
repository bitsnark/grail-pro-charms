...
import { getStateFromNft, prepareSpell } from './signing';
...
async function main() {
  ...
  const argv = minimist(process.argv.slice(2), {
    ...
    default: {
      ...
      'user-payment-txid': '92ffcd600d6b65e926534140b0b4aef460f040c99e523e75cb329bd5a123c8c5',
      'current-threshold': 1,
      'recovery-public-key': 'dffab639dae566030bf76b55082558a55f0e581c7db7e47d354d6f94635df247',
      'timeout-blocks': 10,
      'amount': 1000,
  ...
  const spell = await createPegInSpell(
    ...
    userWalletAddress, userPaymentTxid, network);
