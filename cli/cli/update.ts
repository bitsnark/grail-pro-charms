...
import { GrailState, UpdateRequest } from '../core/types';
import { showSpell } from '../core/charms-sdk';
import config from '../config';
import { Network } from '../core/taproot/taproot-common';
import { prepareSpell } from './utils/signing';
...
export async function updateNft(
  ...
  const signedSpell = await prepareSpell(spell, grailState, null, [{
    publicKey: deployerPublicKey, privateKey: deployerPrivateKey
  }], network);
